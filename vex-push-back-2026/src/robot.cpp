...
// Tracking wheels
lemlib::TrackingWheel vertical_tracking_wheel(&v_tracking, lemlib::Omniwheel::NEW_2, -3);
...
lemlib::ControllerSettings lateral_controller(9, // proportional gain (kP)//10
                                              .1, // integral gain (kI)
